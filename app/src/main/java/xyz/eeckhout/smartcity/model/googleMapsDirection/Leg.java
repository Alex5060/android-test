...
public class Leg {
     ...
     * @param viaWaypoint
     */
    public Leg(Distance distance, Duration duration, DurationInTraffic durationInTraffic, String endAddress, EndLocation endLocation, String startAddress, StartLocation startLocation, List<Step> steps, List<Object> trafficSpeedEntry, List<Object> viaWaypoint) {
        super();
