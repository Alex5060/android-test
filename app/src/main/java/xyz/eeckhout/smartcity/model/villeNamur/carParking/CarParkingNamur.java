...
package xyz.eeckhout.smartcity.model.villeNamur.carParking;
...
public class CarParkingNamur implements Serializable
{
     ...
     * @param facetGroups
     */
    public CarParkingNamur(Integer nhits, Parameters parameters, List<Record> records, List<FacetGroup> facetGroups) {
        super();
        this.nhits = nhits;
