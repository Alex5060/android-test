...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("erreur", "Token "+ PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("accessToken", null));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            TokenDTO token;
            try {
                token = new JwtApi().login(loginDTO);
            }
            ...
            try{
                if(token != null && new JWT(token.getAccessToken()) != null){
                    PreferenceManager.getDefaultSharedPreferences(LoginActivity.this.getApplicationContext()).edit().putString("accessToken", token.getAccessToken()).commit();
                }
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                if(exception.getCode() == 404) {
                    mUsernameView.setError(getString(R.string.login_error_incorrect_username));
